...
- **Support throughout the Research Cycle**
  1. **Plan & Design**
    - [External Funding Opportunities and Support (R & M)](#external-funding)
    - [Content for proposals: Ethics, Privacy, RDM](#proposal-content-rdm)
    - Budget 
    - Impact
  2. **Starting a new project (Time to Grant)**
    - [Awarded, then what?](#awarded-then-what)
    - [Ethics, Data Management and Privacy](#new-rdm)
  3. **Managing ongoing projects**
    - [Changes](#ongoing-changes)
    - [RDM: Data Organization](#ongoing-rdm)
  4. **Reporting,  publishing, and Impact**
    - [PURE & VU Research Portal](#completed-pure)
    - [VU FSS guidelines for archiving data](#completed-rdm)
    - [Support for generating research impact](#impact)
