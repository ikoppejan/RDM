...
This is a draft version of the Research part of the [VU FSS Getting Started guide](https://vu.nl/en/employee/social-sciences-getting-started). The goal is to have a quick overview of all the things Research Office can do for researchers at FSS, presented in a way that it is easy to navigate, even for people not necessarily familiar with the way we work. For now, I have included the names of RSO people after each link, to indicate who is responsible for the content.
...
- **Support throughout the Research Cycle**
  1. **Plan & Design**
    - [FSS Research Funding Opportunities and Support] (Rian & Marleen)](#external-funding)
    - [Content for proposals: Ethics, Privacy, RDM (Koen)](#proposal-content-rdm)
    - Budget (FSS Project controller pages)
